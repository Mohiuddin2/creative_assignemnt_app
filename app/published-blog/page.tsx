  ...
  return (
    <div className="container mx-auto p-4 relative flex">
      ...
      <div className="flex-1">
       ...
       <h1 className="text-4xl font-bold text-center mb-1 md:mb-0">
          
       </h1>
       <Link href="/blog/editor">
         <button className="btn btn-primary">Write  <TbWriting /></button>
          ...
          <div className="card bg-slate-50 text-black shadow-xl">
            <div className="card-body">
              ...
              <div className="card-actions justify-between mt-4">
                <p className="text-sm text-gray-500">By {activePost.author}</p>
